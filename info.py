...
PICS = (environ.get('PICS', 'https://graph.org/file/1b198fddf7def76942176-da9921339b6d1d17b4.jpg')).split()
...
# Others
LOG_CHANNEL = int(environ.get('LOG_CHANELL','-1003948443690'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '-5186910888')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1003367216593')).split()]
